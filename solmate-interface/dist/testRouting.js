...
async function testRouting() {
    ...
    try {
        // Fetch current rates
        const rates = await (0, butlerBackend_1.fetchRates)(false);
        ...
        const proposal1 = (0, butlerBackend_1.decideRebalance)(currentPosition1, rates, 'moderate');
        ...
        const proposal2 = (0, butlerBackend_1.decideRebalance)(currentPosition2, ratesWithLargeDelta, 'moderate');
        ...
        const proposal3 = (0, butlerBackend_1.decideRebalance)(currentPosition3, ratesWithLargeDelta, 'moderate');
